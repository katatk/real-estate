...
while($row = $results->fetch_assoc()) {
    ...
    $output .= "<form method='post' action='process/add-wishlist.php' enctype='multipart/form-data'><a href='add-wishlist?id=" . $row['property_id'] . "'><i class='icon homepage-heart icon-heart-empty shadow'>Add to wishlist</i></a></form>";
